  ...
  return (
    <>
      <Container fluid={true} className="class_mainpage_container">
        <Row>
          <img src={img_banner1} className="class_main_banner1_img"></img>
        </Row>
        <Row>
          <Col sm="2"></Col>
          <Col sm="8" className="class_mainpage_main_text">
            ...
            <p>
              Nos oferecemos os melhores serviços baseado em suas necessidades.
            </p>
          </Col>
          <Col sm="2"></Col>
        </Row>
        <Row className="class_mainpage_row_services">
          ...
          <Col sm="3" className="class_mainpage_col_each">
            ...
            <h3>Sistemas</h3>
            <p>
              Desenvolvimento de sistemas locais ou hospedados, como foco na
              valocidade e segurança dos seus dados.
            </p>
          </Col>
          <Col sm="3" className="class_mainpage_col_each">
          ...
          <Col sm="3" className="class_mainpage_col_each">
            ...
            <h3>E-Commerce</h3>
            <p>
              Amplia sua marca na web,sistemas de transação online oferecendo
              facilidade e comodidade para seus clientes.
            </p>
          </Col>
        </Row>
      </Container>
