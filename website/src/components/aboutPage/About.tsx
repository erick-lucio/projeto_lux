      ...
      <Container className="class_about_container" fluid={true}>
        <Row className="class_about_title_row">
          <Col sm="12" className="class_about_tittle_col">
            ...
            <span>
              Contamos com os mais habilidosos profissionais para alcançar os
              melhorer resultados.
            </span>
          </Col>
        </Row>
        <Row className="class_about_main_row">
          <Col sm="4" className="class_about_each_col">
            <div className="class_about_text_info">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod.{" "}
            </div>
            <div>
              <img src={me_img_developer} className="class_about_imgs"></img>
              <span className="class_about_peope_describe">
                Erick{" "}
                <strong className="class_about_each_profission">
                  {" "}
                  Developer
                </strong>
              </span>
          ...
          <Col sm="4" className="class_about_each_col">
            ...
            <div>
              <img src={me_img_designer} className="class_about_imgs"></img>
              <span className="class_about_peope_describe">
                Erick{" "}
                <strong className="class_about_each_profission">
                  Designer
          ...
          <Col sm="4" className="class_about_each_col">
            ...
            <div>
              <img src={me_img_manager} className="class_about_imgs"></img>
              <span className="class_about_peope_describe">
                Erick{" "}
                <strong className="class_about_each_profission">
                  {" "}
